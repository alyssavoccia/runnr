...
const navItemBase =
  "relative group flex items-center justify-center md:justify-start gap-3 py-2.5 px-3 mb-1 rounded-md text-sm transition-all duration-150 ease-in-out";
  ...
  return (
    <aside className="fixed top-0 left-0 bottom-0 z-50 flex flex-col bg-white border-r border-app-border w-14 md:w-60 transition-all duration-200">
      ...
      <nav className="py-3 px-2 md:px-3 flex-1 overflow-y-auto">
        ...
        <NavItem to="/app/training" icon={NotebookText} label="Training" />
        <NavItem to="/app/shoes" icon={SportShoe} label="Shoes" />
